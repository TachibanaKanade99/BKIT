...
class CheckSuite(unittest.TestCase):
    ...
    **************************************  
    ...
    def test_type_cannot_inferred_array_cell(self):
        input = """
        Function: main
            Body:
                Var: a[10] = {1, 2};
    ...
    def test_func_call_as_index_array_cell(self):
        input = """
        Function: main
            Body:
                Var: a[10] = {1, 2, 3}, b;
    ...
    def test_type_mismatch_index_array_cell(self):
        input = """
        Function: foo
            Parameter: a, b, c
            Body:
        ...
        Function: main
            ...
            EndBody.
        """
        expect = str(TypeMismatchInExpression(ArrayCell(Id("a"), [BinaryOp("*.", CallExpr(Id("foo"), [IntLiteral(1), IntLiteral(2), IntLiteral(3)]), FloatLiteral(1.2))])))
    ...
    def test_array_ele_is_array_lit(self):
        input = """
        Function: main
            Body:
                Var: a[10] = {{1, 2, 3}, {4, 5}}, b = "Hmm";
                a[0] = {1, 2, 3};
                b = a[0];
            EndBody.
        """
        expect = str(TypeMismatchInStatement(Assign(Id("b"), ArrayCell(Id("a"), [IntLiteral(0)]))))
    ...
    def test_two_dimension_array(self):
        ...
        Function: main
            ...
            EndBody.
        """
        expect = str(TypeMismatchInStatement(Assign(ArrayCell(Id("a"), [IntLiteral(0)]), ArrayCell(Id("b"), [IntLiteral(1), IntLiteral(2)]))))
        self.assertTrue(TestChecker.test(input, expect, 492))

    def test_index_and_dimen_lst_not_the_same(self):
        input = """
        Function: main
            Body:
                Var: a[10] = {1, 2, 3, 4, 5};
            ...
            EndBody.
        """
        expect = str(TypeMismatchInExpression(ArrayCell(Id("b"), [IntLiteral(1)])))
        self.assertTrue(TestChecker.test(input, expect, 493))

    def test_cannot_infer_type_func_call_in_array_cell(self):
        input = """
        Function: foo
            Parameter: a
            Body:
        ...
        Function: main
            ...
            EndBody.
        """
        expect = str(TypeCannotBeInferred(Assign(ArrayCell(Id("a"), [CallExpr(Id("foo"), [Id("x")])]), IntLiteral(1))))
        self.assertTrue(TestChecker.test(input, expect, 494))

    def test_arg_is_index_expr(self):
        input = """
        Function: main
            Parameter: a
            Body:
    ...
    def test_arg_in_call_stmt_is_array_type(self):
        input = """
        Function: main
            Parameter: a[10]
            Body:
    ...
    def test_arg_in_call_expr_is_array_type(self):
        input = """
        Function: main
            Body:
                Var: a = 1;
    ...
    def test_expr_in_return_no_type(self):
        input = """
        Var: a;
        Function: fmm
            Body:
    ...
    def test_infer_type_epr_return_stmt(self):
        input = """
        Function: main
            Body:
                Var: b;
    ...
    def test_infer_type_expr_return_stmt_func_is_void_type(self):
        input = """
        Function: main
            Body:
                huhu();
